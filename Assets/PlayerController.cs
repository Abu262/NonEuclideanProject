...
public class PlayerController : PortalTraveller
{
    ...
    private void StartWallrun() 
    {
        ...
        if (rb.velocity.magnitude <= maxWallSpeed) 
        {
            ...
            // Make sure char stiucks to wall
            if (isWallRight)
    ...
    public float crouchGravityMultiplier = 2f;
    ...
    private void OnCollisionStay(Collision other) 
    {
        ...
        // Incoke ground/wall cancel, since we can't check normals with CollisionExit
        float delay = 3f;
    ...
    private void Movement() 
    {
        ...
        // If holding jum[ && ready to jump, then jump
    ...
    private void Jump() 
    {
        ...
        // This I assume is a double jump
        if (!grounded) 
        {
            readyToJump = false;
